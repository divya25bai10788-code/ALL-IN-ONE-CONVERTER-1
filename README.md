...
INR ↔ USD (Uses illustrative, non-live conversion rates)
...
The program runs in an infinite loop and displays a main menu with 7 options.
The user chooses a category, and the corresponding converter function is executed.

After the conversion, the user is returned back to the main menu until they choose Exit Application.
📂 Project Structure

All-in-One Converter Project
│
...
foreign_exchange_converter()	Converts INR ↔ USD (static rate)
numerical_base_converter()	Converts between decimal, binary, octal, hex
